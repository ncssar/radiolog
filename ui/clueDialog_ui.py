...
# Form implementation generated from reading ui file 'C:\Users\caver\Documents\GitHub\radiolog\designer\clueDialog.ui'
#
...
class Ui_clueDialog(object):
    def setupUi(self, clueDialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(570, 510, 161, 51))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.instructionsField.setGeometry(QtCore.QRect(160, 370, 571, 40))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(16)
        ...
        self.locationField.setGeometry(QtCore.QRect(160, 310, 571, 39))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(16)
        ...
        self.clueNumberField.setGeometry(QtCore.QRect(670, 20, 61, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.label_6.setGeometry(QtCore.QRect(590, 20, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 70, 681, 92))
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.callsignField = QtWidgets.QLineEdit(self.groupBox)
        self.callsignField.setEnabled(False)
        self.callsignField.setGeometry(QtCore.QRect(260, 20, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.label_5.setGeometry(QtCore.QRect(260, 40, 171, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.label_8.setGeometry(QtCore.QRect(450, 60, 211, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.label_7.setGeometry(QtCore.QRect(140, 40, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.timeField.setGeometry(QtCore.QRect(140, 20, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.dateField.setGeometry(QtCore.QRect(20, 20, 101, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.radioLocField.setGeometry(QtCore.QRect(450, 10, 211, 63))
        font = QtGui.QFont()
        ...
        self.clueQuickTextButton1.setGeometry(QtCore.QRect(20, 420, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.clueQuickTextButton3.setGeometry(QtCore.QRect(590, 420, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.clueQuickTextButton4.setGeometry(QtCore.QRect(20, 460, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.clueQuickTextButton2.setGeometry(QtCore.QRect(200, 420, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.clueQuickTextButton5.setGeometry(QtCore.QRect(200, 460, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.clueQuickTextButton6.setGeometry(QtCore.QRect(590, 460, 131, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line.setGeometry(QtCore.QRect(100, 490, 551, 31))
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.clueQuickTextButton2_2 = QtWidgets.QPushButton(clueDialog)
        self.clueQuickTextButton2_2.setGeometry(QtCore.QRect(400, 420, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.clueQuickTextButton2_2.setFont(font)
        self.clueQuickTextButton2_2.setFocusPolicy(QtCore.Qt.NoFocus)
        self.clueQuickTextButton2_2.setObjectName("clueQuickTextButton2_2")
        self.clueQuickTextButton2_3 = QtWidgets.QPushButton(clueDialog)
        self.clueQuickTextButton2_3.setGeometry(QtCore.QRect(400, 460, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.clueQuickTextButton2_3.setFont(font)
        self.clueQuickTextButton2_3.setFocusPolicy(QtCore.Qt.NoFocus)
        self.clueQuickTextButton2_3.setObjectName("clueQuickTextButton2_3")
        ...
        self.line.raise_()
        self.clueQuickTextButton2_2.raise_()
        self.clueQuickTextButton2_3.raise_()

        self.retranslateUi(clueDialog)
        self.buttonBox.accepted.connect(clueDialog.accept) # type: ignore
        self.buttonBox.rejected.connect(clueDialog.close) # type: ignore
        self.clueQuickTextButton1.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton2.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton3.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton4.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextUndoButton.clicked.connect(clueDialog.clueQuickTextUndo) # type: ignore
        self.clueQuickTextButton5.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton6.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton2_2.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueQuickTextButton2_3.clicked.connect(clueDialog.clueQuickTextAction) # type: ignore
        self.clueNumberField.editingFinished.connect(clueDialog.clueNumberChanged) # type: ignore
    ...
    def retranslateUi(self, clueDialog):
        ...
        self.clueQuickTextButton3.setText(_translate("clueDialog", "DISREGARD  [F4]"))
        self.clueQuickTextButton3.setShortcut(_translate("clueDialog", "F4"))
        self.clueQuickTextButton4.setText(_translate("clueDialog", "HOLD POSITION  [F5]"))
        self.clueQuickTextButton4.setShortcut(_translate("clueDialog", "F5"))
        ...
        self.clueQuickTextButton5.setText(_translate("clueDialog", "PROTECT THE CLUE  [F6]"))
        self.clueQuickTextButton5.setShortcut(_translate("clueDialog", "F6"))
        self.clueQuickTextButton6.setText(_translate("clueDialog", "STANDBY [F8]"))
        self.clueQuickTextButton6.setShortcut(_translate("clueDialog", "F8"))
        self.clueQuickTextButton2_2.setText(_translate("clueDialog", "PHOTOGRAPH  [F3]"))
