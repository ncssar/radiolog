...
"}")
        ...
        self.changeCallsignLabel3_2 = QtWidgets.QLabel(self.changeCallsignGroupBox)
        self.changeCallsignLabel3_2.setEnabled(False)
        self.changeCallsignLabel3_2.setGeometry(QtCore.QRect(10, 20, 361, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        self.changeCallsignLabel3_2.setFont(font)
        self.changeCallsignLabel3_2.setAlignment(QtCore.Qt.AlignCenter)
        self.changeCallsignLabel3_2.setObjectName("changeCallsignLabel3_2")
    ...
    def retranslateUi(self, newEntryWidget):
        ...
        self.changeCallsignLabel3_2.setText(_translate("newEntryWidget", "(Callsign change takes effect upon leaving this field)"))
