...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.sartopoLayout = QtWidgets.QVBoxLayout()
        self.sartopoLayout.setSpacing(2)
        self.sartopoLayout.setObjectName("sartopoLayout")
        self.sartopoLabel = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        self.sartopoLabel.setFont(font)
        self.sartopoLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.sartopoLabel.setObjectName("sartopoLabel")
        self.sartopoLayout.addWidget(self.sartopoLabel)
        self.sartopoLinkIndicator = QtWidgets.QLineEdit(Dialog)
        self.sartopoLinkIndicator.setEnabled(False)
        self.sartopoLinkIndicator.setMinimumSize(QtCore.QSize(40, 0))
        self.sartopoLinkIndicator.setMaximumSize(QtCore.QSize(80, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.sartopoLinkIndicator.setFont(font)
        self.sartopoLinkIndicator.setAlignment(QtCore.Qt.AlignCenter)
        self.sartopoLinkIndicator.setReadOnly(True)
        self.sartopoLinkIndicator.setObjectName("sartopoLinkIndicator")
        self.sartopoLayout.addWidget(self.sartopoLinkIndicator)
        self.horizontalLayout.addLayout(self.sartopoLayout)
        ...
        self.clueButtonLayout = QtWidgets.QVBoxLayout()
        self.clueButtonLayout.setSizeConstraint(QtWidgets.QLayout.SetDefaultConstraint)
        self.clueButtonLayout.setSpacing(1)
        self.clueButtonLayout.setObjectName("clueButtonLayout")
        ...
        self.clueButtonLayout.addWidget(self.clueLogButton)
        ...
        self.clueButtonLayout.addWidget(self.addNonRadioClueButton)
        self.horizontalLayout.addLayout(self.clueButtonLayout)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/radiolog_ui/icons/help_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/radiolog_ui/icons/options_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/radiolog_ui/icons/empty_filter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/radiolog_ui/icons/print_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.sartopoLabel.setText(_translate("Dialog", "SARTopo"))
        ...
        self.clueLogButton.setText(_translate("Dialog", "Show Clue Log"))
