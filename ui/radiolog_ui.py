...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.caltopoLayout = QtWidgets.QVBoxLayout()
        self.caltopoLayout.setObjectName("caltopoLayout")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.caltopoLogo = QtWidgets.QLabel(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.caltopoLogo.sizePolicy().hasHeightForWidth())
        self.caltopoLogo.setSizePolicy(sizePolicy)
        self.caltopoLogo.setMinimumSize(QtCore.QSize(50, 50))
        self.caltopoLogo.setMaximumSize(QtCore.QSize(50, 50))
        self.caltopoLogo.setText("")
        self.caltopoLogo.setPixmap(QtGui.QPixmap(":/radiolog_ui/icons/caltopo-logo.png"))
        self.caltopoLogo.setScaledContents(True)
        self.caltopoLogo.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.caltopoLogo.setObjectName("caltopoLogo")
        self.horizontalLayout_3.addWidget(self.caltopoLogo)
        ...
        self.caltopoLinkIndicator.setMinimumSize(QtCore.QSize(70, 0))
        self.caltopoLinkIndicator.setMaximumSize(QtCore.QSize(70, 16777215))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.horizontalLayout.addLayout(self.caltopoLayout)
...
"FORMAT"))
        self.caltopoLogo.setToolTip(_translate("Dialog", "CalTopo Integration"))
