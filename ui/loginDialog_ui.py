...
class Ui_loginDialog(object):
    def setupUi(self, loginDialog):
        ...
        self.currentOperatorLabel = QtWidgets.QLabel(loginDialog)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.currentOperatorLabel.setFont(font)
        self.currentOperatorLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.currentOperatorLabel.setObjectName("currentOperatorLabel")
        self.verticalLayout_3.addWidget(self.currentOperatorLabel)
...
"}")
    ...
    def retranslateUi(self, loginDialog):
        ...
        self.currentOperatorLabel.setText(_translate("loginDialog", "Current Operator: Not Logged In"))
        self.label_2.setText(_translate("loginDialog", "Incoming Operator log in below:"))
