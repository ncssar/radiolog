...
class Ui_teamTabsPopup(object):
    def setupUi(self, teamTabsPopup):
        ...
        self.teamTabsSummaryTableWidget.verticalHeader().setDefaultSectionSize(27)
        self.teamTabsSummaryTableWidget.verticalHeader().setMinimumSectionSize(27)
