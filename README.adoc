...
17:36 -- link:https://www.youtube.com/watch?v=pTk-0i6uYUQ&t=17m36s[Printing]
...
Nevada County Sheriff's Search and Rescue (https://ncssar-nc.org) has been using this tool on every callout since early 2015.
...
See the current installation procedure is link:doc/INSTALL.adoc[here].
...
Tom Grundy:: Volunteer - link:https://ncssar-nc.org[Nevada County Sheriff's Search and Rescue], Nevada County, California

Craig Jones:: Volunteer - link:https://redrocksar.org[Red Rock Search and Rescue], Las Vegas, Nevada
