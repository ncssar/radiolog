...
class Ui_newEntryWidget(object):
    def setupUi(self, newEntryWidget):
        ...
        self.label_5.setGeometry(QtCore.QRect(321, 76, 108, 55))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.label_6.setGeometry(QtCore.QRect(250, 93, 53, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.timeField.setGeometry(QtCore.QRect(253, 121, 54, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.radioLocField.setGeometry(QtCore.QRect(331, 121, 286, 30))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        ...
        self.relayedByComboBox.setGeometry(QtCore.QRect(36, 116, 196, 33))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.relayedByLabel.setGeometry(QtCore.QRect(8, 124, 57, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(10)
        ...
        self.datumFormatLabel.setGeometry(QtCore.QRect(430, 94, 195, 22))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.line.setGeometry(QtCore.QRect(299, 101, 40, 48))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(newEntryWidget)
        self.line_2.setGeometry(QtCore.QRect(222, 87, 44, 59))
...
"  }")
    ...
    def retranslateUi(self, newEntryWidget):
        ...
        self.label_5.setText(_translate("newEntryWidget", "Radio GPS:"))
