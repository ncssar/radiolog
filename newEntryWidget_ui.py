...
class Ui_newEntryWidget(object):
    def setupUi(self, newEntryWidget):
        ...
        self.datumFormatLabel.setGeometry(QtCore.QRect(330, 130, 251, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.label_5.setGeometry(QtCore.QRect(220, 100, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.to_fromField.setGeometry(QtCore.QRect(50, 10, 151, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 100, 71, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.radioLocField.setGeometry(QtCore.QRect(330, 100, 251, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.timeField.setGeometry(QtCore.QRect(110, 100, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.teamField.setGeometry(QtCore.QRect(210, 10, 371, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(24)
        font.setBold(True)
