...
#
# Created: Wed Apr  8 07:07:38 2015
...
class Ui_newEntryWidget(object):
    def setupUi(self, newEntryWidget):
        ...
        self.quickTextButton3.setGeometry(QtCore.QRect(440, 210, 231, 31))
        font = QtGui.QFont()
        ...
        self.quickTextButton6.setGeometry(QtCore.QRect(210, 260, 211, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.line_3.setGeometry(QtCore.QRect(100, 240, 681, 20))
        ...
        self.datumFormatLabel.setGeometry(QtCore.QRect(300, 120, 251, 20))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.quickTextButton8.setGeometry(QtCore.QRect(20, 310, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.statusGroupBox.setGeometry(QtCore.QRect(560, 0, 311, 151))
        font = QtGui.QFont()
        ...
        self.label_5.setGeometry(QtCore.QRect(190, 90, 101, 21))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.to_fromField.setGeometry(QtCore.QRect(18, 9, 151, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        ...
        self.quickTextButton2.setGeometry(QtCore.QRect(210, 210, 211, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.quickTextButton1.setGeometry(QtCore.QRect(20, 210, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.messageField.setGeometry(QtCore.QRect(110, 160, 761, 41))
        font = QtGui.QFont()
        ...
        self.quickTextButton5.setGeometry(QtCore.QRect(20, 260, 171, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.quickTextButton9.setGeometry(QtCore.QRect(210, 310, 211, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.buttonBox.setGeometry(QtCore.QRect(690, 280, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(14)
        ...
        self.quickTextButton4.setGeometry(QtCore.QRect(690, 210, 181, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.line_4.setGeometry(QtCore.QRect(100, 290, 461, 20))
        ...
        self.radioLocField = QtWidgets.QLineEdit(newEntryWidget)
        self.radioLocField.setEnabled(False)
        self.radioLocField.setGeometry(QtCore.QRect(300, 90, 251, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.quickTextUndoButton.setGeometry(QtCore.QRect(560, 310, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.timeField.setGeometry(QtCore.QRect(80, 90, 91, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(12)
        ...
        self.teamField.setGeometry(QtCore.QRect(180, 10, 371, 61))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.quickTextButton7.setGeometry(QtCore.QRect(440, 260, 231, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        ...
        self.quickTextButton10.setGeometry(QtCore.QRect(440, 310, 111, 31))
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(9)
        self.quickTextButton10.setFont(font)
        self.quickTextButton10.setFocusPolicy(QtCore.Qt.NoFocus)
        self.quickTextButton10.setCheckable(False)
        self.quickTextButton10.setChecked(False)
        ...
        self.quickTextButton9.clicked.connect(newEntryWidget.quickTextAction)
        self.quickTextUndoButton.clicked.connect(newEntryWidget.quickTextUndo)
        self.quickTextButton8.clicked.connect(newEntryWidget.quickTextClueAction)
        self.teamField.customContextMenuRequested['QPoint'].connect(newEntryWidget.openChangeCallsignDialog)
        self.quickTextButton10.clicked.connect(newEntryWidget.quickTextAction)
    ...
    def retranslateUi(self, newEntryWidget):
        ...
        self.quickTextButton6.setText(_translate("newEntryWidget", "WELFARE CHECK: OK  [F6]"))
        self.quickTextButton6.setShortcut(_translate("newEntryWidget", "F6"))
        self.label.setText(_translate("newEntryWidget", "Message:"))
        self.datumFormatLabel.setText(_translate("newEntryWidget", "DATUM / FORMAT"))
        self.quickTextButton8.setText(_translate("newEntryWidget", "LOCATED A CLUE  [F8]"))
        self.quickTextButton8.setShortcut(_translate("newEntryWidget", "F8"))
        ...
        self.label_5.setText(_translate("newEntryWidget", "Radio Loc.:"))
        ...
        self.quickTextButton5.setText(_translate("newEntryWidget", "RADIO CHECK: OK  [F5]"))
        self.quickTextButton5.setShortcut(_translate("newEntryWidget", "F5"))
        self.quickTextButton9.setText(_translate("newEntryWidget", "REQUESTING DEPUTY  [F9]"))
        self.quickTextButton9.setShortcut(_translate("newEntryWidget", "F9"))
        self.quickTextButton4.setText(_translate("newEntryWidget", "AT IC  [F4]"))
        self.quickTextButton4.setShortcut(_translate("newEntryWidget", "F4"))
        ...
        self.quickTextButton7.setText(_translate("newEntryWidget", "REQUESTING TRANSPORT  [F7]"))
        self.quickTextButton7.setShortcut(_translate("newEntryWidget", "F7"))
        self.quickTextButton10.setText(_translate("newEntryWidget", "STANDBY [F10]"))
        self.quickTextButton10.setShortcut(_translate("newEntryWidget", "F10"))
